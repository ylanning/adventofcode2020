# The three entries in the list are the three numbers that sum to 2020.
...
def find_three_entries_summing_to_target(numbers: list[int], target: int) -> int:
    # iterate range numbers[0] -> numbers[200]
    for i in range(len(numbers)):
        # iterate range numbers[1] -> numbers[200]
        for j in range(i + 1, len(numbers)):
            # iterate range numbers[2] -> numbers[200]
