...
def list_password_policy(password_policy: str) -> list:
    password_policy = input_string.strip().split("\n")
    password_policy = [
        tuple(
            line.split(" ")[0].split("-")
            + list(line.split(" ")[1][0])
        ...
        for line in password_policy
    ]
    return password_policy


password_policies = list_password_policy(input_string)
